  ...
  class ArpPlayer {
    ...
    _loadPianoSampler() {
        ...
        this.sampler = {
            ...
            baseUrl: "/assets/piano_keys/",
            onload: () => {
                sampler.triggerAttackRelease(["C1", "E1", "G1", "B1"], 0.5);
            }
        };
        console.log("222222222222222222    4444   ", this.sampler, this.sampler.baseUrl+this.sampler.urls.A1)
