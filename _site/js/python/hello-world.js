...
function helloworld() {
    ...
    const element = (
        <div className="fade show ">
            <h6 id="hello-world-script-title" className="fs-4 ps-0"></h6>
            ...
            <div className="fs-4 mb-4 p-2 bg-dark card shadow-lg">
                ...
                <div id="hello-world-code-in-page" className="fs-4 fw-lighter" style={{paddingLeft:"1rem"}}></div>
                <py-terminal></py-terminal>
            </div>

            <div className="btn-group pb-4" role="group" aria-label="hello world script">
                <button type="button"  className="btn btn-link btn-none p-0" py-click="hello_world_script()" id="hello-world-manual">
