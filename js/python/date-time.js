const datetime_file_location = "../python/datetime.py";
const code_name = "date-time";
...
function datetime() {
    ...
    const element = (
        <div className="fade show ">
            <h6 id="date-time-script-title" className="fs-4 ps-0"></h6>

            <div id="date-time-config"></div>
            ...
            <div className="fs-4 mb-4 p-2 bg-dark card shadow-lg">
                ...
                <div id="date-time-code-in-page" className="fs-4 fw-lighter" style={{paddingLeft:"1rem"}}></div>
                <py-terminal></py-terminal>
            </div>

            <div className="btn-group" role="group" aria-label="date time script">
                <button type="button" className="btn btn-link btn-none p-0" py-click="date_time_script()" id="date-time-manual">
    ...
    ReactDOM.render(
        element,    
        document.getElementById('date_time_component')
    );
...
$(document).ready(() => {
    ...
    async function getText(file) {
        ...
        if ( newObject.ok !== true ) {
            document.getElementById("date_time_script").innerHTML = "Unknown error";
        } else {
            document.getElementById("date_time_script").innerHTML = printText;
        }
    }
    getText(datetime_file_location);

    fetch(datetime_file_location)
    ...
    .then(ab => {
        ...
        const getCodeDiv = document.getElementById("date-time-code-in-page");
    ...
    var btn = document.getElementById("date-time-manual");
