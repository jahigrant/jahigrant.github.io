      ...
      <div id="quote-box">
        ...
        <div className="row p-0 m-0">
          <div className="col-6 p-0 m-0">
            <button id='new-quote' className="btn btn-primary rounded-1 align-end" onClick={getQuote}>New Quote</button>
          </div>
          <div className="col-6 p-0 m-0">
            <button id='tweet-quote' className="btn btn-primary rounded-1 align-start" onClick={getQuote}>
